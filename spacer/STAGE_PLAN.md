...
| On fail | reward scaling/α,β → tune; grad/NaN → clip/precision; throughput infeasible → reduce worlds, defer to S5; **persistent high collision + sluggishness → not a tuning bug, it's the 2 Hz cadence → S2.5** |
